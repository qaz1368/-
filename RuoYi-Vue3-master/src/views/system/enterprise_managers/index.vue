    ...
    <el-row :gutter="20">
      ...
      <el-col :span="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange" class="full-width-table">
          ...
          <el-table-column label="所属行业" align="center" key="nickName" prop="nickName" v-if="columns[2].visible" :show-overflow-tooltip="true" />
...
import {__esModule as enterprise_managers} from "vue-cropper/dist/vue-cropper.umd";
import {List_enterprise_managers} from "@/api/system/entrepreneurPark/entrepreneurPark";
...
function getList() {
  loading.value = true;
  List_enterprise_managers(proxy.addDateRange(queryParams.value, dateRange.value)).then(res => {
    loading.value = false;
    enterprise_managers.value = res.rows;
